...
/// </summary>
public class DropChipGameManager : MonoBehaviourPunCallbacks // Photon Realtime 用のクラスを継承する
{
    /// <summary>プレイ可能な最大人数</summary>
    [SerializeField] int m_playerCapacity = 2;
    ...
    private void CreateRandomRoom()
    {
        if (PhotonNetwork.IsConnected)
        {
            ...
            roomOptions.MaxPlayers = (byte)m_playerCapacity;
    ...
    public override void OnJoinedRoom()
    {
        ...
        if (playerCount >= m_playerCapacity)
        {
            StartGame();
        }
    }
